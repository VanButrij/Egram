package com.example.ergam.ui.screens.auth
...
import com.example.ergam.databinding.FragmentAuthBinding
import com.example.ergam.ui.screens.main_list.MainListFragment
import com.example.ergam.utilits.APP_ACTIVITY
import com.example.ergam.utilits.launchAndCollectIn
...
class AuthFragment : Fragment(R.layout.fragment_auth) {
    ...
    private fun bindViewModel() {
        ...
        viewModel.authSuccessFlow.launchAndCollectIn(viewLifecycleOwner) {
            showToast("Это отработало")
            APP_ACTIVITY.mAppDrawer.create()
